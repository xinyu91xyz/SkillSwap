...
//        [self updateUserInfo];
//        [self processFieldEntries:self.usernameField.text andPassword:self.passwordField.text];
////        NSLog(@"%@",self.gvc1.self.nameTextField.text);
////        NSLog(@"%@",self.gvc1.emailName);
////        NSLog(@"%@",self.gvc1.schoolName);
////        NSLog(@"%@",self.gvc1.majorName);
////        NSLog(@"%@",self.gvc1.yearEnrolled);
////        NSLog(@"%@",self.gvc1.mySkills);
////        NSLog(@"%@",self.gvc1.wantToLearn);
////        NSLog(@"%@",self.gvc1.myImage);
//    });
//}
...
-(void)updateUserInfo {
    ...
    NSData* data = UIImageJPEGRepresentation(self.gvc1.myImage, 0.8f);
