...
@implementation UpdateImgViewController
...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary *)info
{
    ...
    UIImage *croppedImage = [self squareImageWithImage:image scaledToSize:CGSizeMake(100.0f,100.0f)];
